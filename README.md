...
> In this project, the React-To-do project aimed to learn and master React js. By utilizing React js, the project aimed to build A React-To-do that able to render the To do list and add Todo list to/from local storage.
...
```sh
  cd my-folder
  git clone https://github.com/melkamu12/react-todo-exercise.git
```
...
Feel free to check the [issues page](git@github.com:melkamu12/react-todo-exercise.git).
